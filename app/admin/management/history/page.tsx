  ...
  return (
    <div className="p-5">
      <div className="flex items-start justify-start">
        <Heading
          title={`입금이력정보 (${sortedWallets.length})`}
          description="사용자들의 입금이력정보를 보여줍니다."
        />
      </div>
      ...
      <ScrollArea className="h-[calc(90vh-220px)] rounded-md border">
        <Table>
          <TableCaption>입금이력 정보</TableCaption>
          <TableHeader>
            <TableRow>
              <TableHead
          ...
          <TableBody>
            {sortedWallets.map((wallet) => (
              <TableRow key={wallet.id}>
                ...
                <TableCell>
                {wallet.accept_status === 1 ? "접수됨" : wallet.accept_status === 2 ? "취소됨" : "Pending"}
                </TableCell>
                <TableCell>
